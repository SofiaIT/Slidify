...
library(TH.data)
data(bodyfat)
plot(DEXfat ~ waistcirc, data=bodyfat, main="Relationship between Body Fat and Waist Circumference.  
     A classical example of static plot.", col.main="dodgerblue4", xlab="Waist Circumference", ylab="Body Fat Measured by DXA", pch=16, col="darkolivegreen3")
abline(lm(DEXfat ~ waistcirc, data=bodyfat), col="darkgreen", lty=5, lwd=2)
